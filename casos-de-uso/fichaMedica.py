...
if __name__ == '__main__':
    ...
    while True:
        ...
        if event == '-SALVAR-':
            ...
            if not values['-DECLARACAO_SAUDE-']:
            ...
            respostas_sim = [
                values['-PERGUNTA1_SIM-'], values['-PERGUNTA2_SIM-'], values['-PERGUNTA3_SIM-'],
                values['-PERGUNTA4_SIM-'], values['-PERGUNTA5_SIM-'], values['-PERGUNTA6_SIM-'],
                values['-PERGUNTA7_SIM-']
            ]
