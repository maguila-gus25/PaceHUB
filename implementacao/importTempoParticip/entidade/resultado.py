...
def ordenar_resultados_por_tempo(resultados: list) -> list:
    """
...
def separar_resultados_por_genero(resultados: list) -> tuple:
    """
...
def separar_resultados_por_categoria(resultados: list) -> dict:
    """
...
if __name__ == "__main__":
    ...
    print("=== Teste da Classe Resultado ===")
    
    # Criar um resultado de teste
    resultado = Resultado(
        cpf_atleta="11111111111",
        nome_atleta="Lucas Ferraz",
        genero_atleta="Masculino",
        tempo_final="01:45:30",
        categoria="Júnior"
    )
    
    print(f"Resultado: {resultado}")
    print(f"Tempo em segundos: {resultado.tempo_em_segundos()}")
    print(f"Tem classificação geral: {resultado.tem_classificacao_geral()}")
    
    # Definir classificações
    resultado.definir_classificacao_geral(3)
    resultado.definir_classificacao_categoria(1)
    
    print(f"Após definir classificações: {resultado}")
    ...
    resultado2 = Resultado.from_dict(dados)
    print(f"Resultado recriado: {resultado2}")
    
    # Teste de ordenação
    resultados_teste = [
        Resultado("111", "Atleta A", "Masculino", "02:00:00", "Adulto"),
        Resultado("222", "Atleta B", "Masculino", "01:30:00", "Adulto"),
        Resultado("333", "Atleta C", "Masculino", "01:45:00", "Adulto")
    ]
    
    ordenados = ordenar_resultados_por_tempo(resultados_teste)
